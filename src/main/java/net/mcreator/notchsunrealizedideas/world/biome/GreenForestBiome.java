...
import net.mcreator.notchsunrealizedideas.block.CobblestoneBlock;
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(GrassBlockBlock.block.getDefaultState(),
								CobblestoneBlock.block.getDefaultState(), CobblestoneBlock.block.getDefaultState())));
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(GrassBlockBlock.block.getDefaultState(),
																CobblestoneBlock.block.getDefaultState())))
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = AppleBlock.block.getDefaultState();
