...
import net.mcreator.notchsunrealizedideas.procedures.SaplingRightClickedOnBlockProcedure;
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				SaplingRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
